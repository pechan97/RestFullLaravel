...
<body>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="">
    <h1 class="centrar" >Registro Reuniones</h1>
</div>
        </div>
        <div class="col-lg-4">
        </div>
      ...
      <div class="row">
        ...
        <div class="container">
    <div id = caja>
      <form class="" action="/Reuniones" method="post">
      {!! csrf_field() !!}
      ...
      <div class="form-group">
        ...
        <input id="apellido" type="datatime" value="2017-00-00 00:00:00" class="form-control" name="Fecha">
      </div>
      <div class="form-group">
