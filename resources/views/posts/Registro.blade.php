   ...
   if ((keynum == 8) || (keynum == 46))
    ...
    <div id = caja>
      ...
      <div class="form-group">
        ...
        <input id="apellido" type="text" class="form-control" placeholder="Teléfono" name="PhoneNumber" onkeypress="return solonumeros(event);">
      </div>
      <div class="form-group">
        <label for="examplePhone">Email</label>
        <input id="telef" type=text size="15" class="form-control" placeholder="Email" name="Email">
      </div>
      <div class="form-group">
        <label for="exampleUser">Contraseña</label>
        <input id="user"  type="password" class="form-control" placeholder="Contraseña" name="Password">
      </div>
      <div class="form-group">
