...
<body>
    ...
    <h1 class="centrar" >Registro Soporte</h1>
      ...
      <div class="row">
        ...
        <div class="container">
    <div id = caja>
      <form class="" action="/Soporte" method="post">
      {!! csrf_field() !!}
       ...
       <div class="form-group">
        ...
        <input id="nombre" type="text" class="form-control" placeholder="Titulo" name="Titulo">
      </div>
      <div class="form-group">
        <label for="exampleInputName">Detalle</label>
        <input id="nombre" type="text" class="form-control" placeholder="Detalle" name="Detalle">
      </div>
      <div class="form-group">
